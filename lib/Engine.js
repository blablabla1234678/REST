export class Engine {
    constructor(context, task, objectTask, aliases, natives){
        this.context = context;
        this.task = task;
        this.objectTask = objectTask;
        this.typeAliases = Object.create(typeAliases, aliases);
        this.nativeTypes = Object.create(nativeTypes, natives);
    }
